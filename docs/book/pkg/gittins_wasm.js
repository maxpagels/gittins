...
export class BanditState {
    static __wrap(ptr) {
        const obj = Object.create(BanditState.prototype);
        obj.__wbg_ptr = ptr;
        BanditStateFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
...
export function create(bits, horizon, default_reward, epsilon, forgetfulness) {
    ...
    return BanditState.__wrap(ret[0]);
}
 ...
 * @returns {number}
 */
export function model_bits(state) {
    _assertClass(state, BanditState);
    const ret = wasm.model_bits(state.__wbg_ptr);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ret[0] >>> 0;
...
export function serialize(state) {
    ...
    try {
        _assertClass(state, BanditState);
        const ret = wasm.serialize(state.__wbg_ptr);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./gittins_wasm_bg.js": import0,
    };
}

const BanditStateFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_banditstate_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('gittins_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
