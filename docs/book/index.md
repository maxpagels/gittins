...
Off-policy evaluation in Gittins is done via the command-line tool. You don't need ro run it via binding, or in a notebook. Pass it your experience log, either as plain text or gzipped for efficiency:
